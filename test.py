...
class Calculator(tk.Frame):
	...
	def createWidgets(self):
		...
		self.btnNum1 = tk.Button(self,text = "1",command = self.clickBtnNuml,height = 1,width = 2,font = f2)
		...
		self.btnNum1.grid(row = 1 ,column = 0,sticky = tk.SW + tk.NE)
		self.btnNum2.grid(row = 1 ,column = 1,sticky = tk.SW + tk.NE)
		self.btnNum3.grid(row = 1 ,column = 2,sticky = tk.SW + tk.NE)
		self.btnNum4.grid(row = 2 ,column = 0,sticky = tk.SW + tk.NE)
		self.btnNum5.grid(row = 2 ,column = 1,sticky = tk.SW + tk.NE)
		self.btnNum6.grid(row = 2 ,column = 2,sticky = tk.SW + tk.NE)
		self.btnNum7.grid(row = 3 ,column = 0,sticky = tk.SW + tk.NE)
		self.btnNum8.grid(row = 3 ,column = 1,sticky = tk.SW + tk.NE)
		self.btnNum9.grid(row = 3 ,column = 2,sticky = tk.SW + tk.NE)
		self.btnNum0.grid(row = 4 ,column = 0,columnspan = 2,sticky = tk.SW + tk.NE)
		self.btnSqrt.grid(row = 4,column = 2,sticky = tk.SW + tk.NE)
