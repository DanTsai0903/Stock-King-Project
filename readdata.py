...
test = input()
pp.plot(stockDict_stock[test].date, stockDict_stock[test].closing, label = "Price")
pp.plot(stockDict_stock[test].date, stockDict_stock[test].MA20, label = "Average Price in 20 Days")
pp.plot(stockDict_stock[test].date, stockDict_stock[test].MA60, label = "Average Price in 60 Days")
pp.plot(stockDict_stock[test].date, stockDict_stock[test].MA120, label = "Average Price in 120 Days")
